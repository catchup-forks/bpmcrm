...
use App\Exception\DatabaseConnectionTypeNotSupportedException;
use App\Model\DbSource;
...
final class DatabaseManager
{
     ...
     */
    public function testConnection(array $connectionParams): bool
    {
     ...
     */
    public function registerDatabaseConnectionsForProcess($process): void
    {
    ...
    {
        return match ($engine) {
            'mysql' => [['big5','big5 - Big5 Traditional Chinese'
